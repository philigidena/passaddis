...
import { CreateShopOwnerProfileDto, UpdateShopOwnerProfileDto } from './dto/shop-owner.dto';
export declare class ShopOwnerService {
    private prisma;
    ...
    updateOrderStatus(userId: string, orderId: string, status: 'READY_FOR_PICKUP' | 'COMPLETED'): Promise<{
        user: {
            phone: string;
            name: string | null;
        };
