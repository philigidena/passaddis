...
import { CreateOrganizerProfileDto, UpdateOrganizerProfileDto, CreateEventDto, UpdateEventDto } from './dto/organizer.dto';
export declare class OrganizerService {
    ...
    submitEventForApproval(userId: string, eventId: string): Promise<{
        ticketTypes: {
            id: string;
            description: string | null;
            createdAt: Date;
    ...
    addTicketType(userId: string, eventId: string, dto: any): Promise<{
        id: string;
        description: string | null;
        createdAt: Date;
        updatedAt: Date;
    ...
    updateTicketType(userId: string, eventId: string, ticketTypeId: string, dto: any): Promise<{
        id: string;
        description: string | null;
        createdAt: Date;
        updatedAt: Date;
