...
export declare class AdminService {
    ...
    approveEvent(eventId: string, adminId: string, dto: ApproveEventDto): Promise<{
        organizer: {
            businessName: string;
        } | null;
        ticketTypes: {
    ...
    rejectEvent(eventId: string, adminId: string, dto: RejectEventDto): Promise<{
        organizer: {
            businessName: string;
        } | null;
    } & {
    ...
    toggleEventFeatured(eventId: string): Promise<{
        id: string;
        title: string;
        description: string;
        imageUrl: string | null;
    ...
    verifyOrganizer(merchantId: string, adminId: string, dto: VerifyOrganizerDto): Promise<{
        user: {
            phone: string;
            email: string | null;
            name: string | null;
    ...
    suspendOrganizer(merchantId: string, reason: string): Promise<{
        id: string;
        description: string | null;
        city: string;
        status: import(".prisma/client").$Enums.MerchantStatus;
